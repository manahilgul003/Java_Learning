            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ...
                switch (type) {
                    ...
                    case "movie":
                        ...
                        break;
                    case "audiobook":
                        AudioBook audiobook = gson.fromJson(jsonObject, AudioBook.class);
                        mediaItems.add((T) audiobook);
                        break;
                    case "magazine":
                        Magazine magazine = gson.fromJson(jsonObject, Magazine.class);
                        mediaItems.add((T) magazine);
                        break;
                    default:
